...
TEST(Baranov_Evgeny_MatrixMultiplicationTest, can_correct_sum_long) {
    // Arrange
...
TEST(Baranov_Evgeny_MatrixMultiplicationTest, can_correct_sum_str) {
    // Arrange
    ALNumber number1("1");
    ALNumber number2;
    // Act
    number2 = number1 + "1";
    // Assert
    EXPECT_EQ("2", number2.getValue());
}

TEST(Baranov_Evgeny_MatrixMultiplicationTest, can_correct_sum_long_str) {
    // Arrange
    ALNumber number1("11111111111111111111111111111111111");
    ALNumber number2;
    // Act
    number2 = number1 + "11111111111111111111111111111111111";
    // Assert
    EXPECT_EQ("22222222222222222222222222222222222", number2.getValue());
}

TEST(Baranov_Evgeny_MatrixMultiplicationTest, can_multiple_sum_str) {
    // Arrange
    ALNumber number1("11111111111111111111111111111111111");
    ALNumber number2("11111111111111111111111111111111111");
    ALNumber number3;
    // Act
    number3 = (number1 + "11111111111111111111111111111111111") +
        (number2 + "11111111111111111111111111111111111");
    // Assert
    EXPECT_EQ("44444444444444444444444444444444444", number3.getValue());
}
